...
const DoctorDetails = ({selectedDoctor, closeModal}) => {
    ...
    return (
        <Modal visible={selectedDoctor !== null} animationType="slide" onRequestClose={closeModal}>
          <View style={styles.container}>
            ...
            <View>
              <View style={styles.doctorInfo}>
                    ...
                    <View style={styles.mapContainer}>
                        <MapView
                            ...
                            initialRegion={{
                                ...
                                longitude: selectedDoctor.longtude,
                                latitudeDelta: 0.01,
                                longitudeDelta: 0.01,
                            }}
                        >
                        
                        <Marker title={selectedDoctor.name} description={selectedDoctor.profile.specialization} coordinate={{latitude: selectedDoctor.latitude, longitude: selectedDoctor.longtude}}  />
                ...
                <Button text="الرجوع" buttonStyles={styles.backButton} onPress={closeModal} />
          </View>
        </Modal>
      );
